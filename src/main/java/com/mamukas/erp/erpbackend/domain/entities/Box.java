...
public class Box {
    ...
    public Box(Long idProduct, String name, LocalDate expirationDate, Integer units) {
    ...
    public Box(Long idBox, Long idProduct, String name, LocalDate expirationDate, Integer units, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.idBox = idBox;
        this.idProduct = idProduct;
        this.name = name;
        this.expirationDate = expirationDate;
    ...
    public void removeUnits(int unitsToRemove) {
        if (unitsToRemove > 0 && this.units != null && this.units >= unitsToRemove) {
            ...
            throw new RuntimeException("Insufficient units in box");
        }
    }
